...
SELECT pessoas.primeiro_nome, pessoas.segundo_nome, endereco.cidade FROM pessoas LEFT JOIN endereco USING (id_pessoa);
...
INSERT INTO endereco (id_pessoa, id_endereco, cidade, estado) VALUES (1, 2, 'Rio Branco', 'Acre');
INSERT INTO endereco (id_pessoa, id_endereco, cidade, estado) VALUES (2, 2, 'Rio Branco', 'Acre');